<?php 
// Initialize variable to respective form data
...
$sql = "SELECT patrolcar.patrolcar_id, patrolcar_status.patrolcar_status_desc FROM patrolcar JOIN patrolcar_status ON patrolcar. 
patrolcar_status_id = patrolcar_status.patrolcar_status_id";
...
while ($row = $result -> fetch_assoc()) {
    ...
    // create an array var car to contain the column values of a row
...
if ($btnDispatchClicked == true) {
    ...
    // create var insertIncidentSuccess with initial value 0
	$incidentStatus = 0;
   ...
   for ($i=0; $i<$numofPatrolcarDispatched; $i++) {
   	   // for every element of patrolcarDispatched array...
    ...
    // if able to insert new row incident and update patrolcar table and insert new row in dispatch table
